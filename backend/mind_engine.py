...
══ ИЗВЕСТНОЕ ══════════════════════════════════════════════════
[Элементы мысли в графе. Если есть текстовое основание, дай переваренное определение своими различениями: что это отделяет, от чего зависит, с чем связано, где возникает необходимость. Не упоминай автора или источник.]
